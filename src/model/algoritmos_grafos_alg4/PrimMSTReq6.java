...
package model.algoritmos_grafos_alg4;

import model.graph_alg4.Edge;
import model.graph_alg4.EdgeWeightedGraph;
import model.graph_alg4.In;
import model.graph_alg4.Queue;
import model.graph_alg4.StdOut;
...
public class PrimMSTReq6 {
     ...
     */
    public PrimMSTReq6(EdgeWeightedGraph G) {
        edgeTo = new Edge[G.V()];
    ...
    private void scan(EdgeWeightedGraph G, int v) {
        ...
        for (Edge e : G.adj(v)) {
            ...
            if (e.costoDistanciaHarversine() < distTo[w]) {
                distTo[w] = e.costoDistanciaHarversine();
                edgeTo[w] = e;
    ...
    public double weight() {
        double weight = 0.0;
        for (Edge e : edges())
            weight += e.costoDistanciaHarversine();
        return weight;
    }
    ...
    private boolean check(EdgeWeightedGraph G) {
        ...
        for (Edge e : edges()) {
            totalWeight += e.costoDistanciaHarversine();
        }
        ...
        for (Edge e : edges()) {
            ...
            for (Edge f : G.edges()) {
                ...
                if (uf.find(x) != uf.find(y)) {
                    if (f.costoDistanciaHarversine() < e.costoDistanciaHarversine()) {
    ...
    public static void main(String[] args) {
        ...
        PrimMSTReq6 mst = new PrimMSTReq6(G);
